...
def create_data(v_dic, i_dic):
	...
	print pearson_def(ccr_v_array[time_lag:], ccr_i_array[0:final_lag])
	print pearson_def(ccr_v_array[time_lag:], ccr_iv_array[0:final_lag])
	print pearson_def(ccr_v_array[time_lag:], ccr_op_array[0:final_lag])
